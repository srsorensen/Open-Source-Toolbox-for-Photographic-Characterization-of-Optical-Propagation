...
directory = "C:/Users/simon/PycharmProjects/Open-Source-Toolbox-for-Rapid-and-Accurate-Photographic-Characterization-of-Optical-Propagation/Processed data/GaAs/New/"
...
directory = ("C:/Users/simon/PycharmProjects/Open-Source-Toolbox-for-Rapid-and-Accurate-Photographic-Characterization-of-Optical-Propagation/Processed data/GaAs/Outlier/")
contains = "GST3"
f_ending = ".h5"
...
plot_fontsize = 21
te_dataframe, te_mean, te_std = plot_polarization_data(dataframe_wav, TE_data, TE_wav, "TE new", "b", [910, 980.1],TE_weights)
te_dataframe1, te_mean1, te_std1 = plot_polarization_data(dataframe_wav,TE_data1,TE_wav1,"TE old","r",[910,980.1],TE_weights1)
#te_dataframe2, te_mean2, te_std2 = plot_polarization_data(dataframe_wav,TE_data2,TE_wav2,"TE","b",[910,980.1],TE_weights2)
tm_dataframe, tm_mean, tm_std = plot_polarization_data(dataframe_wav, TM_data, TM_wav, "TM new", "g", [910, 980.1],TM_weights)
tm_dataframe1, tm_mean1, tm_std1 = plot_polarization_data(dataframe_wav,TM_data1,TM_wav1,"TM old","k",[910,980.1],TM_weights1)
...
print(tm_mean[911],tm_std[911])
print(tm_mean[945],tm_std[945])
print(tm_mean[978],tm_std[978])

plt.figure(figsize=(10, 6))



#print(te_std[973:975])
c1 = "#377eb8"
c2 = "#a65628"
c3 = "#000000"
if not te_dataframe.empty:
    plt.plot(te_mean.index, te_mean,color=c1,label="New method")
    ...
    plt.plot(te_mean.index, te_mean - te_std,linestyle="-", color=c1, alpha=0.3)
    plt.plot(te_mean1.index, te_mean1,color=c2,label="Old method")
...
if not tm_dataframe.empty:
    plt.figure(figsize=(10, 6))
    plt.plot(tm_mean.index, tm_mean,color=c1,label="New method")
    ...
    plt.plot(tm_mean.index, tm_mean - tm_std, linestyle="-", color=c1, alpha=0.2)
    plt.plot(tm_mean1.index, tm_mean1,color=c2,label="Old method")
