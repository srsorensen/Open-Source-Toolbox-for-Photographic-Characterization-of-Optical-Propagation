This repository contains the Python script SPA.py for scattering analysis of both straight and spiral waveguides. The toolbox is compatible with any USB camera driver.
